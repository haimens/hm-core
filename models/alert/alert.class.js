...
class VNAlert extends ODInstance {
    ...
    static async findFlightAlertInSystem() {
        try {
            ...
            conditions
                ...
                .configSimpleCondition(`vn_alert.record_time > DATE_SUB(now(), INTERVAL 3 HOURS)`)
    ...
    static async findAlertInSystem() {
        try {
            ...
            conditions
                ...
                .configComplexConditionQueryItem('vn_realm', 'status', 2)
                .configSimpleCondition(`vn_alert.record_time < now()`)
                .configSimpleCondition(`(vn_alert.type = 1 OR vn_alert.type = 2 OR vn_alert.type = 3)`)
